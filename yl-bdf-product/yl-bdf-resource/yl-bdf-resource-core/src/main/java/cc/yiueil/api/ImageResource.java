...
public interface ImageResource {
     ...
     */
    ImageUploadResult upload(InputStream inputStream, String fileName, String fileType, boolean watermark) throws FileUploadException;
     ...
     * @throws FileUploadException 文件上传异常
     */
    default ImageUploadResult upload(InputStream inputStream, String fileName, String fileType) throws FileUploadException {
