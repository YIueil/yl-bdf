...
public class SwaggerConfig {
	...
	@Value("${swagger.basePackage:cn.yiueil}")
	private String basePackage;
	
	@Bean
    public Docket docket() {
	 	String bp = StringUtils.isBlank(basePackage) ? "cn.yiueil" : basePackage;
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"1.0", // 接口版本号
				"www.yiueil.cn", // 团队地址
				new Contact("YIueil", "www.yiueil.cn", "yiueil@163.com"), // 作者信息
				"nameless", // 许可证
